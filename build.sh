...
apk add build-base clang openssl-dev nghttp2-dev nghttp2-static libssh2-dev libssh2-static libpsl-dev libpsl-static perl
...
LDFLAGS="-static" PKG_CONFIG="pkg-config --static" ./configure --disable-shared --enable-static --disable-ldap --enable-ipv6 --enable-unix-sockets --with-ssl --with-libssh2 --disable-docs --without-libpsl
